...
export const en = {
  ...
  'integrations.description':
    'Connect tool sources — OpenAPI, MCP HTTPS, and plugin packs. Composio and Pipedream land with HP-59.',
  ...
  'integrations.composioBody': 'Managed catalog. HP-59 will wire this — no silent fake connect.',
  'integrations.pipedreamTitle': 'Pipedream Connect',
  'integrations.pipedreamBody': 'Managed catalog. HP-59 will wire this — no silent fake connect.',
  ...
  'integrations.toolsHint': 'Qualified names from MCP sync and OpenAPI import. Collisions get a __2 suffix.',
  'integrations.noTools': 'No typed tools yet. Import OpenAPI or sync an HTTP MCP server.',
