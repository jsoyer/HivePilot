...
export const en = {
  ...
  'alerts.title': 'Alerts',
  'alerts.subtitle': 'Failed runs and degraded plugins land here.',
  'alerts.placeholder':
    'The Alerts list ships in a follow-up. The header chip already counts failed runs and degraded plugins.',
