...
export const en = {
  ...
  'efficiency.cacheUnamortisedDescription': 'Median per run below 1.0: the step created more cache than it has ever reused. Creation costs 1.25x base input, a read 0.1x — so this is full price, every run. Usually something variable sitting ahead of something stable in the prompt.',
