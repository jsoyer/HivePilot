...
export const fr: Record<TranslationKey, string> = {
  ...
  'integrations.description':
    'Connecte les sources d’outils — OpenAPI, MCP HTTPS et packs de plugins. Composio et Pipedream arriveront avec HP-59.',
  ...
  'integrations.composioBody': 'Catalogue managé. HP-59 le branchera — pas de connexion fantôme.',
  'integrations.pipedreamTitle': 'Pipedream Connect',
  'integrations.pipedreamBody': 'Catalogue managé. HP-59 le branchera — pas de connexion fantôme.',
  ...
  'integrations.toolsHint': 'Noms qualifiés issus du sync MCP et de l’import OpenAPI. Collision → suffixe __2.',
  'integrations.noTools': 'Aucun outil typé. Importe de l’OpenAPI ou synchronise un serveur MCP HTTP.',
