...
export const fr: Record<TranslationKey, string> = {
  ...
  'alerts.subtitle': 'Les runs en échec et les plugins dégradés atterrissent ici.',
  'alerts.placeholder':
    'La liste d’Alertes arrive dans un PR suivant. Le jeton du header compte déjà les runs en échec et les plugins dégradés.',
