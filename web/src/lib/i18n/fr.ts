...
export const fr: Record<TranslationKey, string> = {
  ...
  'header.allClear': 'RAS',
  'header.issues': '{count} incidents',
  'header.overflow': 'Plus',
  'header.theme': 'Thème',
  'header.language': 'Langue',
  'header.signOut': 'Se déconnecter',
  'inbox.title': 'Inbox',
  'inbox.subtitle': 'Parle aux agents. Le lab est à portée via ⌘K.',
  'inbox.snapshot': 'Snapshot',
  'inbox.snapshotCollapse': 'Replier le snapshot',
  'inbox.snapshotExpand': 'Déplier le snapshot',
  'inbox.kpiSpend': 'Dépense 24h',
  'inbox.kpiSpendSub': 'dernières 24h',
  'inbox.kpiSuccess': 'Réussite',
  'inbox.kpiSuccessSub': '{count} runs',
  'inbox.kpiPending': 'En attente',
  'inbox.kpiPendingSub': 'approbations',
  'inbox.issuesBreakdown': '{failed} en échec · {degraded} dégradé',
  'inbox.openAlerts': 'Alertes',
  'alerts.title': 'Alertes',
  'alerts.subtitle': 'Les plus graves d’abord · même fil que Telegram',
  'alerts.empty': 'Rien à signaler. Le fil est vide.',
  'alerts.kind.failed': 'Échec',
  'alerts.kind.degraded': 'Dégradé',
  'alerts.kind.classifier': 'Classifieur',
  'alerts.meta.installedDisabled': 'Installé mais désactivé',
  'alerts.meta.degradedFallback': 'Dégradé',
  'alerts.classifier.healthy': 'Concierge en forme',
  'alerts.classifier.down': 'Concierge down',
  'alerts.classifier.reachable': 'joignable',
  'alerts.classifier.unreachable': 'injoignable',
  ...
  'nav.alerts': 'Alertes',
  'nav.plus': 'Plus',
  'nav.plusHint': 'Le reste via ⌘K',
  'nav.rooms': 'Salles',
  'nav.chat': 'Chat',
  'chat.empty': 'Parlez aux agents — le concierge route votre message.',
  'chat.placeholder': 'Écrire aux agents…',
  'chat.send': 'Envoyer',
  'chat.inputAria': 'Message au concierge',
  'chat.thinking': 'Réflexion…',
  'chat.error': 'Impossible de joindre le concierge. Réessayez.',
  'chat.proposalTitle': 'Action suggérée',
  'chat.proposalNote': 'Proposition seulement — lancez-la via Approbations / Runs.',
  'chat.approvalTitle': 'Approbation requise',
  'chat.approvalHint': 'Résout le run en attente via la même API Approbations.',
  'chat.approvalDone': 'Run {id} {result}.',
  'chat.intentTitle': 'Action proposée',
  'chat.intentMeta': 'intent: {kind} · confirmation requise',
  'chat.intentConfirm': 'Confirmer',
  'chat.intentCancel': 'Annuler',
  'chat.intentProject': 'projet {project}',
  'chat.intentBranch': 'branche {branch}',
  'chat.intentLaunchPipeline': 'Lancer le pipeline {pipeline}',
  'chat.intentLaunchTask': 'Lancer {task}',
  'chat.intentApproveRun': 'Approuver le run {id}',
  'chat.intentDenyRun': 'Refuser le run {id}',
  'chat.intentPipelineFallback': 'pipeline',
  'chat.intentFallback': '{kind}',
  'chat.intentDenyReason': 'Refusé via le concierge Inbox',
  'chat.intentDoneApproval': 'Run {id} {result}.',
  'chat.intentDoneRun': 'Run {id} lancé.',
  'chat.intentDoneAck': 'Confirmé. Rien n’a été lancé automatiquement — terminer via Approbations / Runs.',
  'chat.intentCancelled': 'Annulé. Rien n’a été lancé.',
  'chat.intentApproved': 'approuvé',
  'chat.intentDenied': 'refusé',
  'voice.dictate': 'Dicter',
  'voice.stopDictation': 'Arrêter la dictée',
  'voice.call': 'Appeler un agent',
  'voice.hangUp': 'Raccrocher',
  ...
  'memoryBackends.about.hindsight': 'Hindsight retain/recall, banque projet:tâche:rôle. En loopback ça reste sur la box ; Cloud / une URL distante sort de la machine.',
  ...
  'integrations.description':
    'Connecte les sources d’outils — OpenAPI, MCP HTTPS, Composio, Pipedream Connect et packs de plugins.',
  'integrations.readOnly': 'Lecture seule — un jeton admin est requis pour importer, synchroniser ou installer.',
  'integrations.forbidden': 'Cette action nécessite un jeton admin.',
  'integrations.comingSoon': 'Bientôt',
  'integrations.openapiTitle': 'OpenAPI',
  'integrations.openapiHint': 'Colle un document OpenAPI 3 / Swagger 2. Les outils sont catalogués, pas invoqués.',
  'integrations.openapiName': 'Nom de la source',
  'integrations.openapiPlaceholder': '{"openapi":"3.1.0","info":{"title":"…"},"paths":{…}}',
  'integrations.import': 'Importer',
  'integrations.importing': 'Import…',
  'integrations.mcpTitle': 'Sync MCP HTTPS',
  'integrations.mcpHint': 'Liste les outils d’un serveur MCP HTTP déjà enregistré. L’import/catalogue reste dans l’onglet MCP.',
  'integrations.sync': 'Synchroniser',
  'integrations.syncing': 'Sync…',
  'integrations.noHttpMcp': 'Aucun serveur MCP HTTP. Ajoutes-en un dans l’onglet MCP, puis synchronise ici.',
  'integrations.composioTitle': 'Composio',
  'integrations.composioHint': 'Liste les outils d’un toolkit. Catalogués, pas exécutés.',
  'integrations.composioNeedKey': 'Définis HIVEPILOT_COMPOSIO_API_KEY pour synchroniser. Pas de connexion fantôme.',
  'integrations.composioToolkit': 'Slug toolkit (ex. github)',
  'integrations.pipedreamTitle': 'Pipedream Connect',
  'integrations.pipedreamHint': 'Liste les actions d’une app. Cataloguées, pas exécutées.',
  'integrations.pipedreamNeedKey':
    'Définis HIVEPILOT_PIPEDREAM_CLIENT_ID, HIVEPILOT_PIPEDREAM_CLIENT_SECRET et HIVEPILOT_PIPEDREAM_PROJECT_ID. Pas de connexion fantôme.',
  'integrations.pipedreamApp': 'Slug app (ex. slack)',
  'integrations.packsTitle': 'Packs de plugins',
  'integrations.packsHint': 'Bundles curés déclaratifs (HP-77). L’install exige un consentement admin.',
  'integrations.installPack': 'Installer',
  'integrations.installing': 'Installation…',
  'integrations.noPacks': 'Aucun pack de plugins sur cet hôte.',
  'integrations.toolsTitle': 'Outils typés',
  'integrations.toolsHint':
    'Noms qualifiés issus de MCP, OpenAPI, Composio et Pipedream. Collision → suffixe __2.',
  'integrations.noTools': 'Aucun outil typé. Importe de l’OpenAPI ou synchronise une source catalogue.',
  'integrations.toolName': 'Nom qualifié',
  'integrations.toolSource': 'Source',
  'integrations.toolLocal': 'Nom local',
  'mcp.description':
    'Serveurs MCP et catalogue sur une page. Colle du JSON, une URL ou une commande. La santé est sondée à la lecture ; le coût par serveur n’est pas encore mesuré.',
  'mcp.importPlaceholder': '{"mcpServers":{…}}  ·  https://…  ·  npx -y @modelcontextprotocol/server-…',
  'mcp.import': 'Importer',
  'mcp.importing': 'Import…',
  'mcp.forbidden': 'Cette action nécessite un jeton admin.',
  'mcp.readOnly': 'Lecture seule — un jeton admin est requis pour importer ou retirer un serveur.',
  'mcp.secretsStripped': 'Les secrets en clair n’ont pas été stockés : {keys}',
  'mcp.serversTitle': 'Serveurs installés',
  'mcp.catalogTitle': 'Catalogue',
  'mcp.noServers': 'Aucun serveur MCP dans le registre. Colle une config ou ajoute-en un depuis le catalogue.',
  'mcp.server': 'Serveur',
  'mcp.transport': 'Transport',
  'mcp.target': 'Cible',
  'mcp.status': 'Santé',
  'mcp.unprobed': 'non sondé',
  'mcp.probe': 'Sonder',
  'mcp.remove': 'Retirer',
  'mcp.add': 'Ajouter',
  'mcp.installed': 'Ajouté',
  'mcp.costNote':
    'Le coût par serveur MCP n’est pas encore suivi (HP-73 mesure les providers LLM, pas les appels d’outils).',
  'nav.approvals': 'Approbations',
  'nav.runs': 'Exécutions',
  'nav.spaces': 'Espaces',
  'spaces.description': 'Salles de conversation — parle à un agent, ou regarde deux agents travailler ensemble.',
  'spaces.emptyTitle': 'Aucun espace pour l’instant',
  'spaces.emptyBody': 'Un espace est une salle de conversation avec un ou plusieurs agents. Crées-en un pour commencer.',
  'spaces.you': 'Toi',
  'spaces.messageCount': '{count} messages',
  'spaces.noSelection': 'Choisis un espace à gauche pour ouvrir sa conversation.',
  'spaces.noMessages': 'Aucun message — écris quelque chose pour démarrer.',
  ...
  'orchestrator.description':
    'Découpe un objectif en mission, choisis comment les tasks s’exécutent et mergent, puis lance.',
  'orchestrator.readOnly':
    'Lecture seule — un jeton de rang run est requis pour découper et lancer.',
  'orchestrator.forbidden': 'Cette action nécessite un jeton de rang run.',
  'orchestrator.goalPlaceholder': 'Décris l’objectif à découper…',
  'orchestrator.projectPlaceholder': 'Projet (optionnel)',
  'orchestrator.decompose': 'Découper',
  'orchestrator.decomposing': 'Découpe…',
  'orchestrator.strategyTitle': 'Stratégie d’exécution & de merge',
  'orchestrator.planTitle': 'Plan — {count} task(s)',
  'orchestrator.launch': 'Lancer la mission',
  'orchestrator.launching': 'Lancement…',
  'orchestrator.launched': 'Mission #{mission} lancée — {count} run(s) créé(s).',
  'strategy.sequential': 'Séquentiel (dans cette mission)',
  'strategy.new_mission': 'Séquentiel (nouvelle mission)',
  'strategy.pipeline': 'Pipeline complet code → review → merge',
  'strategy.code_only_self_merge': 'Code seul — chacun merge sa branche',
  'strategy.code_only_final_merge': 'Code seul — un seul merge à la fin',
  'strategy.guarantee.sequential': 'Un pipeline, stages en séquence.',
  'strategy.guarantee.newMission': 'Spawné comme mission/run séparé(e).',
  'strategy.guarantee.pipeline': 'Le plus sûr, ~+6 min/task, pour la nuit.',
  'strategy.guarantee.codeSelfMerge': 'Plus rapide ; chaque coder merge sa propre branche.',
  'strategy.guarantee.codeFinalMerge': 'Code seul, un Merger merge tout à la fin.',
  'strategy.dispatch.sequential': 'séquentiel',
  'strategy.dispatch.parallel': 'parallèle',
  'strategy.merge.per_task': 'merge par task',
  'strategy.merge.per_branch': 'merge par branche',
  'strategy.merge.final': 'merge final',
  'strategy.merge.none': 'sans merge',
  // ---- Panneau Providers (HP-73 : usage + visibilité repli HP-70) ------
  'nav.providers': 'Providers',
  'providers.description':
    'Coût réel enregistré par provider (30 j) et où les modèles ont basculé (HP-70, 24 dernières h).',
  'providers.noData': 'Aucune activité provider enregistrée pour l’instant.',
  'providers.overallSpend': 'Coût total (30 j)',
  'providers.providerCount': 'Providers',
  'providers.fallbackCount': 'Replis ({hours} h)',
  'providers.provider': 'Provider',
  'providers.cost': 'Coût',
  'providers.tokens': 'Tokens',
  'providers.status': 'État',
  'providers.healthy': 'Pas de repli récent',
  'providers.fallbackBadge': '{count}× bascule · {reason}',
  ...
  'providers.connectTitle': 'Connecter un modèle',
  'providers.connectDescription':
    'La clé est vérifiée chez le provider, puis écrite dans le .env hôte (0600). Elle n’apparaît jamais dans le YAML HivePilot ni dans la réponse.',
  'providers.connectProvider': 'Provider',
  'providers.connectKey': 'Clé API',
  'providers.connectBaseUrl': 'URL de base (optionnel)',
  'providers.connectSave': 'Vérifier et enregistrer',
  'providers.connectSaving': 'Vérification…',
  'providers.connectSaved': 'Enregistré {envKey}',
  'providers.connectNeedAdmin': 'Un jeton admin est requis pour enregistrer une clé.',
  'providers.connectNeedKey': 'Collez d’abord une clé.',
  'providers.login': 'Se connecter',
  'providers.loginWorking': 'Démarrage du login…',
  'providers.loginNoUrl': 'Login lancé — ouvrir le journal CLI sur la machine ({log}).',
  'nav.autopilot': 'Autopilote',
  'nav.partitions': 'Partitions',
  'nav.workshop': 'Skills',
  'workshop.title': 'Atelier de skills',
  'workshop.subtitle':
    'Relire les patches de skill proposés avant qu’ils n’atterrissent sur disque. Rien ne s’applique tant que vous n’acceptez pas.',
  'workshop.empty': 'Aucun patch de skill proposé.',
  'workshop.accept': 'Accepter',
  'workshop.reject': 'Refuser',
  'workshop.needApprove': 'Accepter ou refuser un patch demande un jeton de rang approve.',
  'workshop.evolutionTitle': 'Évolution de skill',
  'workshop.evolutionSubtitle':
    'Relire le diff multi-fichier et le lignage, approuver ou refuser, puis accepter. Rien n’est écrit avant l’approbation.',
  'workshop.evolutionEmpty': 'Aucun brouillon d’évolution de skill.',
  'workshop.approve': 'Approuver',
  'workshop.acceptReady': 'Accepter écrit les fichiers approuvés de façon atomique.',
  'workshop.acceptBlocked': 'Approuver ce brouillon avant d’accepter. Le HITL est obligatoire.',
  'workshop.lineage': 'Lignage',
  'workshop.files': 'Fichiers',
  'workshop.validation': 'Validation',
  'nav.agents': 'Agents',
  'nav.studio': 'Studio',
  'studio.title': 'Agent Studio',
  'studio.subtitle': 'Créer, éditer et retirer des rôles. Les écritures demandent un jeton admin.',
  'studio.new': 'Nouveau rôle',
  'studio.empty': 'Aucun rôle dans le store pour l’instant.',
  'studio.colRole': 'Rôle',
  'studio.colProfile': 'Profil',
  'studio.colRunner': 'Runner',
  'studio.colOrder': 'Ordre',
  'studio.editorAria': 'Éditeur de rôle',
  'studio.close': 'Fermer',
  'studio.fieldName': 'Nom',
  'studio.fieldTitle': 'Titre',
  'studio.fieldDisplayName': 'Nom affiché',
  'studio.fieldProfile': 'Profil modèle',
  'studio.fieldRunner': 'Runner',
  'studio.fieldModel': 'Modèle',
  'studio.fieldInputs': 'Entrées (séparées par des virgules)',
  'studio.fieldOutputs': 'Sorties (séparées par des virgules)',
  'studio.fieldOrder': 'Ordre',
  'studio.fieldCanBlock': 'Peut bloquer le pipeline',
  'studio.fieldPrompt': 'Prompt',
  'studio.promptFileHint': 'Fichier prompt YAML : {file}. Collez du texte ici pour le stocker en base.',
  'studio.save': 'Enregistrer',
  'studio.delete': 'Supprimer',
  'studio.deleteConfirm': 'Supprimer le rôle {name} ?',
  'studio.needAdmin': 'Un jeton admin est requis pour modifier les rôles.',
  ...
  'conversations.runsWithSpeech': 'Runs qui ont parlé',
  'conversations.filHint': 'Fil interactions · actor → target',
  'conversations.expand': 'Déplier',
  'conversations.collapse': 'Replier',
  'conversations.surfaceCaption': 'Board · History · Conversations — une seule porte',
  ...
  'agents.binaries.checkRemote': 'Vérifier le distant',
  'agents.binaries.remoteLabel': 'distant',
  'agents.binaries.remoteUnknown': 'impossible de lire la version distante',
  ...
  'board.attentionFilterLabel': "Filtrer le tableau par zone d'attention",
  'board.allZones': 'Toutes',
  'board.zoneNeedsYou': 'À traiter',
  'board.zoneInReview': 'En revue',
  'board.zoneWorking': 'En cours',
  'board.zoneQueued': 'En file',
  'board.zoneReady': 'Prêt',
  'board.zoneOther': 'Autre',
