...
- [SKILLS.md](./SKILLS.md) — skill sources, HP-98 catalog, HP-107 BM25 retrieval, HP-108 skill→tools gate, HP-109 drafts, HP-110 validator, HP-111 atomic accept, HP-112 host skills, HP-113 eval contract, HP-114 optional hybrid RRF, HP-117 local package tree, workshop
