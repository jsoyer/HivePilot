...
values. No automatic cutover — leftover forum topics 2118–2121 are
forgotten only via `hivepilot topics cutover --yes` after CoS GO, then
deleted in Telegram or `topics prune`.
