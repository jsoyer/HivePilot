...
def test_full_structured_markdown_style() -> None:
    ...
    text = (
        ...
        "high\n"
        "## links\n"
        "/home/jeromesoyer/Documents/Github/jsoyer/obsidian-vault/Acme/artifact.md\n"
    )
    ...
    assert any(
        "/home/jeromesoyer/Documents/Github/jsoyer/obsidian-vault/Acme/artifact.md" in link
