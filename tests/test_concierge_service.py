...
class TestConciergeRunnerSelection:
    ...
    def test_claude_cli_path_still_enforces_no_tools(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr(concierge_service.settings, "chatops_concierge_runner", "claude")
        ...
        assert runner_def.options.get("tools") == concierge_service._CLASSIFIER_NO_TOOLS
