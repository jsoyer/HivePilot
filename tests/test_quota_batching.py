...
def test_dev_batch_size_config_default(monkeypatch):
    """dev_batch_size defaults to 0 (unlimited), regardless of ambient env/.env state."""
    from hivepilot.config import Settings

    monkeypatch.delenv("HIVEPILOT_DEV_BATCH_SIZE", raising=False)
